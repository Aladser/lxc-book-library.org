<section class='content-section theme-mb'>
    ...
    <form class='mx-auto mb-3' method="POST" action=<?php echo $routes['store']; ?>>
        ...
        class="theme-grey-bgcolor border-1 d-block w-100 mb-2 p-3" placeholder="Почта" title="Почта" required>

        <input type="password" name='password'
        class="theme-grey-bgcolor border-1 d-block w-100 mb-2 p-3" placeholder="Пароль (минимум 3 символа)" title="Пароль" required>

        <input type="password" name='password_confirm'
        class="theme-grey-bgcolor border-1 d-block w-100 mb-2 p-3" placeholder="Подтвердите пароль" title="Подтвердите пароль" required>
