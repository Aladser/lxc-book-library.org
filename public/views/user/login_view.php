<section class='content-section theme-mb'>
    ...
    <form method="POST" class='mx-auto' action="<?php echo $routes['auth']; ?>">
        <input type='text' class='theme-grey-bgcolor border-1 d-block w-100 mb-2 p-3' name='login' placeholder="Почта" title="Почта" required>
        <input type="password" class='theme-grey-bgcolor border-1 d-block w-100 mb-2 p-3' name='password' placeholder="Пароль" title="Пароль" required>
        <!-- кнопки формы -->
