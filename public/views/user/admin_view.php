<div class='container'>
    <section class='admin-section'>
        ...
        <a href="<?php echo $routes['authors']; ?>" class='button-basic theme-border d-block mx-auto mb-2 w-100'>Авторы</a>
        <a href="<?php echo $routes['genres']; ?>" class='button-basic theme-border d-block mx-auto mb-2 w-100'>Жанры</a>
